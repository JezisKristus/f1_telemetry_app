...
class DBManager:
    ...
    def setup_tables(self):
        ...
        # Grid-wide lap data (Low-frequency) [cite: 46]
        self.cursor.execute('''
        ...
        # Player/Teammate Micro-telemetry (High-frequency) [cite: 47]
        self.cursor.execute('''
        ...
        # Setup and aerodynamic data [cite: 48]
        self.cursor.execute('''
